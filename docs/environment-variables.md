...
| `OPENROUTER_MANAGEMENT_KEY`     | OpenRouter billing/usage administration          | Showing account credits/balance in usage views                 | Usage-only management key; never used for model inference                                           |
